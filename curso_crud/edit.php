...
$aluno = DAOAluno::getInstance()->select($_GET['idAluno']);
...
<body>
 ...
 <div id="main" class="container-fluid">
  ...
  <h3 class="page-header"><?php echo $aluno->getNome();?></h3>
  
  <form action="index.html">
  	<div class="row">
  	  <div class="form-group col-md-4">
  	  	<label for="exampleInputEmail1">Campo Um</label>
  	  	<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Digite o valor" value="<?php echo $aluno->getEmail();?>">
  	  </div>
	  <div class="form-group col-md-4">
